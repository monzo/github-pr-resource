...
type FakeGithub struct {
	...
	ListPullRequestsStub        func([]githubv4.PullRequestState, string, *time.Time) ([]*resource.PullRequest, error)
...
func (fake *FakeGithub) ListPullRequests(arg1 []githubv4.PullRequestState, arg2 string, arg3 *time.Time) ([]*resource.PullRequest, error) {
...
func (fake *FakeGithub) ListPullRequestsCalls(stub func([]githubv4.PullRequestState, string, *time.Time) ([]*resource.PullRequest, error)) {
	fake.listPullRequestsMutex.Lock()
